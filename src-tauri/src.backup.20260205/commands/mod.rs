...
// pub mod schede_cliente; // Schede cliente verticali per settori specifici - TEMP DISABILITATO per fix sqlx 0.8+
...
pub use orari::*;
pub use rag::*;
// pub use schede_cliente::*; // TEMP DISABILITATO
// Re-export additional functions for lib.rs compatibility - TEMP DISABILITATI
