...
class TestNLUPipelineIntegration:
    ...
    @pytest.mark.parametrize(
        "verticale_id,text,expect_blocked",
        [
    ...
    def test_guardrail_with_vertical_key(
        self, verticale_id: str, text: str, expect_blocked: bool
    ) -> None:
...
class TestSubVerticalExtraction:
    ...
    @pytest.mark.parametrize(
        "verticale_id,text,expected_sub_vertical",
        [
            # hair
    ...
    def test_sub_vertical_extraction(
        self, verticale_id: str, text: str, expected_sub_vertical: str
    ) -> None:
...
class TestMedicoSpecialtyExtraction:
    ...
    @pytest.mark.parametrize(
        "verticale_id,text,expected_specialty",
        [
    ...
    def test_medico_specialty_extraction(
        self, verticale_id: str, text: str, expected_specialty: str
    ) -> None:
        from src.entity_extractor import extract_vertical_entities
