...
from verticals.salone.intents import classify, IntentType  # noqa: E402
from verticals.salone.entities import EXTRACTOR  # noqa: E402
from verticals.salone.schema import create_booking, create_customer  # noqa: E402
...
class TestSaloneBookingE2E:
    ...
    def test_e2e_prenotazione_taglio(self):
        ...
        assert (
            entities["time"] == "15:00" or entities["time"] is None
        )  # Può essere None se non matcha "alle 15"

        # Step 3: Create customer
        customer = create_customer(nome="Marco", telefono="+39123456789")
    ...
    def test_e2e_prenotazione_con_preferenze(self):
        ...
        assert entities.get("operator") is None or entities.get(
            "operator", ""
        ).lower() in ["maria", "prenotare"]
