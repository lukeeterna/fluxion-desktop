...
from verticals.palestra.intents import classify, IntentType  # noqa: E402
from verticals.palestra.entities import EXTRACTOR  # noqa: E402
from verticals.palestra.schema import create_booking, create_member  # noqa: E402
...
class TestPalestraBookingE2E:
    ...
    def test_e2e_prenotazione_pt(self):
        ...
        member = create_member(nome="Luca", telefono="+39123456789")
