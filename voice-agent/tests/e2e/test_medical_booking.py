...
from verticals.medical.intents import classify, IntentType  # noqa: E402
from verticals.medical.entities import EXTRACTOR  # noqa: E402
from verticals.medical.schema import create_booking, create_patient  # noqa: E402
...
class TestMedicalBookingE2E:
    ...
    def test_e2e_prenotazione_visita(self):
        ...
        patient = create_patient(
            nome="Giulia", cognome="Rossi", telefono="+39123456789"
        )
