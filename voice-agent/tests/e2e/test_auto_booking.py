...
from verticals.auto.intents import classify, IntentType  # noqa: E402
from verticals.auto.entities import EXTRACTOR  # noqa: E402
from verticals.auto.schema import create_booking, create_vehicle  # noqa: E402
...
class TestAutoBookingE2E:
    ...
    def test_e2e_prenotazione_tagliando(self):
        ...
        vehicle = create_vehicle(targa="AB123CD", modello="Fiat Panda")
