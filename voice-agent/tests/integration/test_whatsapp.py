...
class TestWhatsAppIntegration:
    ...
    async def test_send_booking_confirmation(self):
        ...
        template_data = {
            ...
            "language": "it",
            "parameters": {"service": "taglio", "date": "14/02/2026", "time": "15:00"},
        }

        result = await mock_whatsapp.send_template_message(
            to="+39123456789", template=template_data
        )
    ...
    async def test_send_reminder(self):
        ...
        result = await mock_whatsapp.send_message(to="+39123456789", body=reminder_text)
    ...
    async def test_receive_message_webhook(self):
        ...
        webhook_data = {
            "entry": [
                {"changes": [{"value": {"messages": [{"from": "+39123456789"}]}}]}
            ]
        }
