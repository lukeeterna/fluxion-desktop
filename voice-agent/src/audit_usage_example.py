...
def example_3_gdpr_operations():
    ...
    audit_client.log_client_view(
        session_id="voice-session-123", cliente_id="cust-456", search_query="Rossi"
    )
...
def example_4_booking_operations():
    ...
    audit_client.log_booking_reschedule(
        session_id=session_id,
        appuntamento_id="appt-789",
        old_data={"data": "2025-03-15", "ora": "15:00"},
        new_data={"data": "2025-03-20", "ora": "16:00"},
    )
...
def example_6_multiple_instances():
    ...
    audit_v2.log_client_creation(
        session_id="session-xyz", cliente_id="cust-999", cliente_data={"nome": "Test"}
    )
...
def example_8_decorator_usage():
    ...
    create_client_sync(
        session_id="test-session", data={"nome": "Mario", "cognome": "Rossi"}
    )
