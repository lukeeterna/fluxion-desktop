...
DEFAULT_PROVIDERS: List[ProviderConfig] = [
    # B3-FIX2 (#34v): NLU a capitolato §2 = llama-3.3-70b (era llama-3.1-8b-instant).
    # Cerebras rimosso: model "llama3.1-8b" inesistente → HTTP 404 a ogni turno
    #   (latenza + rumore). Ri-abilitazione con model valido = task futuro.
    ProviderConfig(
        name="groq",
