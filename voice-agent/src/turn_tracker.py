...
class FluxionTurnTracker:
            ...
            """,
                {
                    ...
                    "llm_prompt": turn.llm_prompt[:2000]
                    if turn.llm_prompt
                    else "",  # Troncato
                    "llm_response": turn.llm_response[:2000]
                    if turn.llm_response
                    else "",
                    "llm_model": turn.llm_model,
                    "tts_model": turn.tts_model,
                    "response_text": turn.response_text[:2000]
    ...
    def get_session_turns(self, session_id: str, limit: int = 100) -> List[TurnRecord]:
    ...
    def get_latency_stats(
        self, hours: int = 24, vertical_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
