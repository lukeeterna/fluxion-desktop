...
_MEDICAL_SPECIALTIES: Dict[str, List[str]] = {
    ...
    "dermatologia": ["dermatologo", "dermatologa", "dermatologia", "dermatologica", "dermatologico", "pelle", "nei", "mappatura nei"],
    ...
    "pediatria": ["pediatra", "pediatria", "pediatrica", "pediatrico", "bambino", "bimbo", "neonato"],
    "oculistica": ["oculista", "oculistica", "oculistico", "vista", "occhi", "miopia", "astigmatismo"],
    "odontoiatria": ["dentista", "odontoiatra", "odontoiatria", "odontoiatrica", "odontoiatrico",
                     "dentale", "denti", "carie", "otturazione", "estrazione",
                     "devitalizzazione", "sbiancamento denti", "invisalign", "aligner dentale",
                     "ortodonzia", "ortodontista", "impianto dentale", "pulizia denti"],
    "neurologia": ["neurologo", "neurologa", "neurologia", "neurologica", "neurologico", "emicrania", "cefalea", "nervo"],
    "endocrinologia": ["endocrinologo", "endocrinologa", "endocrinologia", "endocrinologica", "endocrinologico", "tiroide", "diabete", "ormoni"],
    "reumatologia": ["reumatologo", "reumatologa", "reumatologia", "reumatologica", "reumatologico", "artrite", "artrosi", "fibromialgia"],
    "fisioterapia": ["fisioterapia", "fisioterapica", "fisioterapico", "fisioterapista", "fisio", "riabilitazione", "rieducazione",
                     "tecarterapia", "ultrasuoni terapia", "kinesiotaping", "onde d'urto", "dry needling"],
    "osteopata": ["osteopata", "osteopatia", "osteopatica", "osteopatico", "trattamento osteopatico", "cranio-sacrale",
                  "osteopatia viscerale", "manipolazione osteopatica"],
    "psicologo": ["psicologo", "psicologa", "psicologica", "psicologico", "psicoterapeuta", "psicoterapia", "TCC", "EMDR",
                  "terapia cognitivo-comportamentale", "supporto psicologico",
                  "seduta di coppia", "terapia di coppia"],
    "nutrizionista": ["nutrizionista", "nutrizionistica", "nutrizionistico", "dietologo", "dietologa", "dieta personalizzata", "piano alimentare",
                      "BIA", "bioimpedenziometrica", "alimentazione sportiva"],
    "podologo": ["podologo", "podologa", "podologia", "podologica", "podologico", "plantari", "unghia incarnita", "calli",
