...
VERTICAL_SERVICES: Dict[str, Dict[str, List[str]]] = {
    ...
    "auto": {
        ...
        "detailing": [
            ...
            "wrapping auto",
            "car wrapping",
            "pellicola protezione vernice",
            "lavaggio ad ozono",
            "ozono abitacolo",
            "sanificazione ozono",
            "interno cuoio trattamento",
    ...
    "beauty": {
        ...
        "massaggio_corpo": [
            ...
            "massaggio decontratturante corpo",
            "massaggio ayurvedico",
            "massaggio shiatsu corpo",
            "massaggio svedese",
        ],
        "linfodrenaggio": [
            "linfodrenaggio",
        ...
        "semipermanente_unghie": [
            "semipermanente unghie",
            "smalto semipermanente",
            "gel semipermanente",
            "semipermanente mani",
            "semipermanente piedi",
            "ripassata semipermanente",
        ],
        "nail_art": [
            "nail art",
            "decorazioni unghie",
    ...
    "medico": {
        ...
        "dermatologia": [
            ...
            "dermatologia",
            "mappatura nei",
            "mappatura nei completa",
            "crioterapia dermatologica",
            "visita dermatologica mole",
        ],
        "cardiologia": [
            "cardiologo",
            "cardiologia",
...
DURATION_MAP: Dict[str, Dict[str, int]] = {
    ...
    "auto": {
        ...
        "scarico": 90,
        "revisione": 60,
        "carrozzeria_servizi": 480,
        "elettrauto": 120,
        "gommista_servizi": 60,
        "revisione_servizi": 60,
        "detailing": 180,
    },
    "professionale": {
        "commercialista": 60,
...
_AMBIGUOUS_DATE_COMPILED = [
    re.compile(p, re.IGNORECASE) for p in AMBIGUOUS_DATE_PATTERNS
]
...
_FLEXIBLE_SCHEDULING_COMPILED = [
    re.compile(p, re.IGNORECASE) for p in FLEXIBLE_SCHEDULING_PATTERNS
]
