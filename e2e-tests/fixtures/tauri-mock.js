...
const FATTURE = [
    { id: 1, numero: '2026/001', numero_fattura: '2026/001', cliente_id: 1, cliente_nome: 'Maria Rossi', data_emissione: '2026-03-01T10:00:00', data: '2026-03-01T10:00:00', importo_totale: 65.00, importo: 65.00, stato: 'pagata', tipo: 'fattura', note: '' },
    { id: 2, numero: '2026/002', numero_fattura: '2026/002', cliente_id: 3, cliente_nome: 'Francesca Romano', data_emissione: '2026-03-03T11:00:00', data: '2026-03-03T11:00:00', importo_totale: 120.00, importo: 120.00, stato: 'pagata', tipo: 'fattura', note: '' },
    { id: 3, numero: '2026/003', numero_fattura: '2026/003', cliente_id: 9, cliente_nome: 'Chiara Conti', data_emissione: '2026-03-05T09:30:00', data: '2026-03-05T09:30:00', importo_totale: 85.00, importo: 85.00, stato: 'pagata', tipo: 'fattura', note: '' },
    { id: 4, numero: '2026/004', numero_fattura: '2026/004', cliente_id: 2, cliente_nome: 'Giulia Bianchi', data_emissione: '2026-03-08T14:00:00', data: '2026-03-08T14:00:00', importo_totale: 55.00, importo: 55.00, stato: 'da_pagare', tipo: 'fattura', note: '' },
    { id: 5, numero: '2026/005', numero_fattura: '2026/005', cliente_id: 7, cliente_nome: 'Elena Ricci', data_emissione: '2026-03-12T16:00:00', data: '2026-03-12T16:00:00', importo_totale: 92.00, importo: 92.00, stato: 'da_pagare', tipo: 'fattura', note: '' },
    { id: 6, numero: '2026/006', numero_fattura: '2026/006', cliente_id: 5, cliente_nome: 'Anna Colombo', data_emissione: '2026-03-15T10:30:00', data: '2026-03-15T10:30:00', importo_totale: 35.00, importo: 35.00, stato: 'pagata', tipo: 'ricevuta', note: '' },
    { id: 7, numero: '2026/007', numero_fattura: '2026/007', cliente_id: 4, cliente_nome: 'Luca Ferrari', data_emissione: '2026-03-17T11:00:00', data: '2026-03-17T11:00:00', importo_totale: 32.00, importo: 32.00, stato: 'da_pagare', tipo: 'ricevuta', note: '' },
];
const INCASSI_OGGI = {
    totale: 182.00,
    contanti: 97.00,
...
const MOCK_HANDLERS = {
    ...
    search_clienti: (args) => {
        ...
        return CLIENTI.filter(c => `${c.nome} ${c.cognome}`.toLowerCase().includes(q));
    },
    ...
    get_incassi_oggi: () => ({
        ...
        numero_transazioni: 3,
        incassi: [
            { id: '1', cliente_id: 1, cliente_nome: 'Maria Rossi', servizio_nome: 'Colore Completo', importo: 65.00, metodo_pagamento: 'carta', data: `${TODAY}T09:45:00`, note: '' },
            { id: '2', cliente_id: 9, cliente_nome: 'Chiara Conti', servizio_nome: 'Meches / Balayage', importo: 85.00, metodo_pagamento: 'carta', data: `${TODAY}T11:30:00`, note: '' },
            { id: '3', cliente_id: 4, cliente_nome: 'Luca Ferrari', servizio_nome: 'Taglio + Barba', importo: 32.00, metodo_pagamento: 'contanti', data: `${TODAY}T10:45:00`, note: '' },
        ],
    }),
    ...
    get_analytics_mensili: () => ({
        ...
        top_operatori: [
            { id: '1', nome: 'Valentina Marini', appuntamenti: 89, revenue: 3250, clienti_unici: 54 },
            { id: '2', nome: 'Roberto Gatti', appuntamenti: 67, revenue: 2180, clienti_unici: 42 },
            { id: '3', nome: 'Sara De Luca', appuntamenti: 72, revenue: 2890, clienti_unici: 38 },
        ],
    }),
