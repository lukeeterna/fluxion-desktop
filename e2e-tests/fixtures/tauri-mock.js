...
(() => {
  ...
  const SERVIZI = [
    { id: 1, nome: "Taglio Donna", durata: 45, prezzo: 35, categoria: "taglio", attivo: 1 },
    { id: 2, nome: "Taglio Uomo", durata: 30, prezzo: 22, categoria: "taglio", attivo: 1 },
    { id: 3, nome: "Piega", durata: 30, prezzo: 25, categoria: "styling", attivo: 1 },
    { id: 4, nome: "Colore Completo", durata: 90, prezzo: 65, categoria: "colore", attivo: 1 },
    { id: 5, nome: "Meches / Balayage", durata: 120, prezzo: 85, categoria: "colore", attivo: 1 },
    { id: 6, nome: "Trattamento Cheratina", durata: 60, prezzo: 55, categoria: "trattamento", attivo: 1 },
    { id: 7, nome: "Barba", durata: 20, prezzo: 15, categoria: "uomo", attivo: 1 },
    { id: 8, nome: "Taglio + Barba", durata: 45, prezzo: 32, categoria: "uomo", attivo: 1 },
    { id: 9, nome: "Acconciatura Sposa", durata: 120, prezzo: 120, categoria: "evento", attivo: 1 },
    { id: 10, nome: "Shampoo + Piega", durata: 40, prezzo: 30, categoria: "styling", attivo: 1 }
  ];
  const OPERATORI = [
  ...
  const APPUNTAMENTI_OGGI = [
    { id: 1, cliente_id: 1, cliente_nome: "Maria Rossi", servizio_id: 4, servizio_nome: "Colore Completo", operatore_id: 3, operatore_nome: "Sara De Luca", data: TODAY, ora: "09:00", durata: 90, stato: "completato", prezzo: 65, note: "" },
    { id: 2, cliente_id: 9, cliente_nome: "Chiara Conti", servizio_id: 5, servizio_nome: "Meches / Balayage", operatore_id: 1, operatore_nome: "Valentina Marini", data: TODAY, ora: "09:30", durata: 120, stato: "completato", prezzo: 85, note: "" },
    { id: 3, cliente_id: 4, cliente_nome: "Luca Ferrari", servizio_id: 8, servizio_nome: "Taglio + Barba", operatore_id: 2, operatore_nome: "Roberto Gatti", data: TODAY, ora: "10:00", durata: 45, stato: "completato", prezzo: 32, note: "" },
    { id: 4, cliente_id: 5, cliente_nome: "Anna Colombo", servizio_id: 1, servizio_nome: "Taglio Donna", operatore_id: 4, operatore_nome: "Matteo Greco", data: TODAY, ora: "11:00", durata: 45, stato: "confermato", prezzo: 35, note: "" },
    { id: 5, cliente_id: 2, cliente_nome: "Giulia Bianchi", servizio_id: 3, servizio_nome: "Piega", operatore_id: 1, operatore_nome: "Valentina Marini", data: TODAY, ora: "14:00", durata: 30, stato: "confermato", prezzo: 25, note: "" },
    { id: 6, cliente_id: 7, cliente_nome: "Elena Ricci", servizio_id: 6, servizio_nome: "Trattamento Cheratina", operatore_id: 3, operatore_nome: "Sara De Luca", data: TODAY, ora: "14:30", durata: 60, stato: "confermato", prezzo: 55, note: "" },
    { id: 7, cliente_id: 6, cliente_nome: "Marco Esposito", servizio_id: 2, servizio_nome: "Taglio Uomo", operatore_id: 2, operatore_nome: "Roberto Gatti", data: TODAY, ora: "15:30", durata: 30, stato: "in_attesa", prezzo: 22, note: "" },
    { id: 8, cliente_id: 10, cliente_nome: "Paolo Gallo", servizio_id: 7, servizio_nome: "Barba", operatore_id: 2, operatore_nome: "Roberto Gatti", data: TODAY, ora: "16:30", durata: 20, stato: "in_attesa", prezzo: 15, note: "" }
  ];
  ...
  const MOCK_HANDLERS = {
    ...
    get_top_operatore_kpi: () => ({
      id: "1",
      nome_completo: "Valentina Marini",
      mese: "2026-03",
      appuntamenti_completati: 89,
      no_show: 2,
      clienti_unici: 54,
      fatturato_generato: 3250,
      ticket_medio: 36.52
    }),
    get_top_operatori_mese: () => [
      { id: "1", nome_completo: "Valentina Marini", mese: "2026-03", appuntamenti_completati: 89, no_show: 2, clienti_unici: 54, fatturato_generato: 3250, ticket_medio: 36.52 },
      { id: "2", nome_completo: "Roberto Gatti", mese: "2026-03", appuntamenti_completati: 67, no_show: 1, clienti_unici: 42, fatturato_generato: 2180, ticket_medio: 32.54 },
      { id: "3", nome_completo: "Sara De Luca", mese: "2026-03", appuntamenti_completati: 72, no_show: 3, clienti_unici: 38, fatturato_generato: 2890, ticket_medio: 40.14 }
    ],
    // Clienti
    get_clienti: () => CLIENTI,
    search_clienti: (args) => {
      ...
      return CLIENTI.filter(
        (c) => `${c.nome} ${c.cognome}`.toLowerCase().includes(q)
      );
    },
    ...
    get_operatore: (args) => OPERATORI.find((o) => o.id === args?.id) || OPERATORI[0],
    ...
    get_appuntamento: (args) => APPUNTAMENTI_OGGI.find((a) => a.id === args?.id) || APPUNTAMENTI_OGGI[0],
    // Fatture
    get_fatture: () => FATTURE,
    ...
    get_incassi_oggi: () => ({
      ...
      incassi: [
        { id: "1", cliente_id: 1, cliente_nome: "Maria Rossi", servizio_nome: "Colore Completo", importo: 65, metodo_pagamento: "carta", data: `${TODAY}T09:45:00`, data_incasso: `${TODAY}T09:45:00`, categoria: "servizio", descrizione: "Colore Completo", note: "" },
        { id: "2", cliente_id: 9, cliente_nome: "Chiara Conti", servizio_nome: "Meches / Balayage", importo: 85, metodo_pagamento: "carta", data: `${TODAY}T11:30:00`, data_incasso: `${TODAY}T11:30:00`, categoria: "servizio", descrizione: "Meches / Balayage", note: "" },
        { id: "3", cliente_id: 4, cliente_nome: "Luca Ferrari", servizio_nome: "Taglio + Barba", importo: 32, metodo_pagamento: "contanti", data: `${TODAY}T10:45:00`, data_incasso: `${TODAY}T10:45:00`, categoria: "servizio", descrizione: "Taglio + Barba", note: "" }
      ]
    }),
    ...
    get_report_incassi_periodo: () => ({ totale: 8420, media_giornaliera: 468, giorni: 18 }),
    // Orari
    get_orari_lavoro: () => [
    ...
    get_analytics_summary: () => ({
      fatturato_mese: 8420,
      fatturato_mese_precedente: 7650,
    ...
    // Suppliers
    list_suppliers: () => [
      { id: 1, nome: "L'Or\xE9al Professionnel", contatto: "Marco Verdi", telefono: "02 1234 5678", email: "ordini@loreal.it", note: "Fornitore principale colori" },
