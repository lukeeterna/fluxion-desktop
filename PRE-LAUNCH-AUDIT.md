...
| ID | Item | Status | Evidenza | Priorità | ETA | Agent | Dipendenze |
|----|------|--------|----------|----------|-----|-------|------------|
| F-1 | FAQ pubblica landing con 20+ domande PMI (installazione, attivazione, garanzia, refund, GDPR, Sara, WhatsApp, SDI) | **COMPLETE** | S187 — `landing/faq.html` 24 Q&A in 8 categorie + search filter + JSON-LD FAQPage SEO + 53 anchor link `related` validati. Footer index.html updated. | **P0** | 2h | `support-responder` + `content-creator` | nessuna |
| F-2 | Support runbook (gianlucadistasi `support-responder` + email template top-20 issue) | **COMPLETE** | Commit `1aa25c9` S187 — runbook 1989 lines, top-20 issue + 15 email templates + escalation tree + metrics framework. Deployed. | **P0** | 2.5h | `support-responder` | nessuna |
