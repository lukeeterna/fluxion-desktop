...
2026-08-02 | T-CERT-GATE/#47 | MACCHINA | c143dd9 | — | VERDE | F1: iMac 2c25742→c143dd9 (stash+ff-only); F2: 4 SHA256 identici iMac=MacBook; F3: vos_check.sh g)+PROTOCOLLO R30; F4: :3002 PID 41118 VOICE_ENGINE=go SARA_TEST_CAPTURE=1 registered=True reg_status=200; F5: COPIONE SSH rimosso; F6: c57e6ade+9636bbc7 già assenti (COUNT=15→15) | T-CERT-GATE/#47@c143dd9
