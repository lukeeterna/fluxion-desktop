...
2026-08-03 | T-GUARDRAIL-1/#49 | MACCHINA | a30341d7 | 22036535 | VERDE | F1: installer sha OK; 4 SHA256 PASS; F3: R31-33 aggiunte PROTOCOLLO (nessuna sovrascrittura R30); F4: 3 file copiati, ETICHETTA SAFE_AUTO→CONFIRM_FIRST; F5: MacBook=repo_auth, iMac=runtime_auth, stesso origin/master, MACHINES.json ACTIVE senza UUID/IP/user/path; F6: a/b/c PASS fail-closed; BUG verify KeyError repo_root segnalato a Sol | T-GUARDRAIL-1/#49@a30341d7
2026-08-03 | T-VOS-CORE/#53 | MACCHINA | 23b8a5c0 | 31ebaa0b | VERDE | bin/vos_apply.sh wrapper reale (no PLACEHOLDER), 4 eseguibili+2 test+8 mandati seeded, regole 34-40 PROTOCOLLO, 6/6 test OK | T-VOS-CORE@23b8a5c:aa7712d6afcc
2026-08-04 | T-MACCHINA | MACCHINA | 8741c5da | — | VERDE | vos_imac_pulse.py creato, IMAC-PULSE.json live (head=1a17f072 registered=True reg_status=200 SHA256 4/4 match), check h) aggiunto vos_check.sh, 15 test OK, vos_check 8/0 PASS MacBook+iMac allineati | T-MACCHINA@8741c5d:3d991b8b2375f1bd
2026-08-07 | T-EXPOSURE/v2 | MACCHINA | 2762fb67 | — | VERDE | M1-M6: 5 path untracked via git rm --cached (byte-preserved: db 565248/shm 32768/wal 358472/lic 417/bak 2494), tools/draft-bus-supervisor -> quarantena privata 20260807T125950Z, EXPOSURE_HISTORY.json (history NON riscritta), vos_check branch PASS=7 FAIL=1 (solo a HEAD!=origin), PR esecuzione aperta no-automerge, next=INDEPENDENT_REVIEW_T_EXPOSURE_EXECUTION_PR | T-EXPOSURE@439c71f8
